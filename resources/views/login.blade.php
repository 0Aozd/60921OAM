<header>
    <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
        <div class="container-fluid">
            <a class="navbar-brand" href="/">EasyMoney</a>
                ...
                <ul class="navbar-nav me-auto mb-2 mb-md-0">
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle active" aria-current="page" data-bs-toggle="dropdown"
                            href="{{url('transaction')}}">Транзакции</a>
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="{{url('transaction')}}">Все транзакции</a></li>
                            <li><a class="dropdown-item" href="{{url('transaction/create')}}">Добавить транзакцию</a></li>
                            <li><hr class="dropdown-divider"></li>
                            <li><a class="dropdown-item" href="#">Валюты</a></li>
                        </ul>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#">Бюджеты</a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link disabled" aria-disabled="true" href="#">Регулярные платежи</a>
                    </li>
                </ul>
